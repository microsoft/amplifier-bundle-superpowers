...
1. **Create a notes file early**: `write_file("/tmp/review-notes.md", "# Quality Review Notes\n")` at the start of your review.
2. **Append findings as you go**: After each verification step, append results to your notes file (test outcomes, python_check results, code observations, issues found).
